...
import { Image as ImageType } from "@/models/equipments"
import Image from "next/image";
import { FaArrowLeft, FaArrowRight } from "react-icons/fa";
import { MdCancel } from "react-icons/md";


const EventPhotoGallery: FC<{photos: ImageType[]}>= ({photos}) => {
    ...
    <div className='container mx-auto'>
      <div className='grid md:grid-cols-2 relative gap-5 px-3'>
        <div className='h-[540px] relative rounded-2xl overflow-hidden'>
            ...
            <Image
              src={photos[0].url}
              alt={`Equipment Photo ${currenPhotoIndex + 1}`}
          ...
          {remainingPhotosCount > 0 && (
            ...
            >
              <Image
                ...
                alt={`Equipment Photo ${maximumVisiblePhotos}`}
                className='img'
              />
